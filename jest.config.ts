...
//   // cacheDirectory: "/private/var/folders/pr/8fqlw3_94336l73f4c_1s5p80000gn/T/jest_dx",
...
export default {
  ...
  // testPathIgnorePatterns: ["node_modules/(?!<package_name>)/",],
  testPathIgnorePatterns: ["/node_modules/", "/lib/", "/esm/", "/dist/"],
  moduleFileExtensions: ["ts", "tsx", "js", "jsx", "json", "node"],
  // 覆盖率从哪些文件收集，设置后即便0覆盖率的文件也会计算进来
  // collectCoverageFrom: [
    // "src/**/*.{ts,tsx,js,jsx}",
    // "!**/node_modules/**",
    // "!**/dist/**",
