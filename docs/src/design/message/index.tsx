...
import { Infofill, SuccessFill, ErrorFill, WarningFill } from '../Icons/icon';
...
function Message(Props: IProps) {
  ...
  const [iconNode, seticonNode] = useState(<Infofill width={15} height={15} color="#1890FF" />);
...
Message.info = (content: string | IProps, duration?: number, onClose?: Function) =>
  MessageControl('info', content, duration, onClose);
Message.success = (content: string | IProps, duration?: number, onClose?: Function) =>
  MessageControl('success', content, duration, onClose);
Message.error = (content: string | IProps, duration?: number, onClose?: Function) =>
  MessageControl('error', content, duration, onClose);
Message.warning = (content: string | IProps, duration?: number, onClose?: Function) =>
